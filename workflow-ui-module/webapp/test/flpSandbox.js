		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#PurchaseOrderWorkflowworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"PurchaseOrderWorkflowworkflowuimodule-display": {
								"semanticObject": "PurchaseOrderWorkflowworkflowuimodule",
								"action": "display",
								"description": "A workflow for Purchase Order",
								"title": "Task UI app title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=PurchaseOrderWorkflow.workflowuimodule",
									"url": sap.ui.require.toUrl("PurchaseOrderWorkflow/workflowuimodule")
								}
							}
						}
					}
